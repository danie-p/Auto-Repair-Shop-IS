...
public class ExtendibleHashFile<T extends IData<T>> extends HeapFile<T> {
    ...
    private int getDirectoryIndex(T record) {
        ...
        return BitSetUtility.bitSetToInt(firstDBits);
    }
    ...
    @Override
    public T delete(int blockAddress, T recordWithKey) {
        return null;
    }
}
